...
{
    /**
     * $_dbTable - instance of tribialfeminista\Mapper\DbTable\TableAbstract
     *
     * @var tribialfeminista\Mapper\DbTable\TableAbstract
     */
    protected $_dbTable;
     ...
     *
     * @param tribialfeminista\Mapper\DbTable\TableAbstract $dbTable
     * @return tribialfeminista\Mapper\Sql\Raw\MapperAbstract
     */
     ...
     * @param tribialfeminista\Model\Raw\ModelAbstract $model
    ...
    public function loadRelated($type, $name, $model, $conditions = null, $orderBy = null)
    {
        ...
        if ('parent' == $type && array_key_exists($name, $parents)) {
            ...
            $table_class = 'tribialfeminista\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
            ...
            $ref_table_name = 'tribialfeminista\\Mapper\\Sql\\DbTable\\' . $object_table_name;
            $rule = $name;
        } else {
        ...
        if ($this->_cache &&
            ...
            $relMapperClassName = "\\tribialfeminista\\Mapper\\Sql\\" . $object_table_name;
     ...
     *
     * @see tribialfeminista\Mapper\DbTable\TableAbstract::countAllRows()
     ...
     *
     * @see tribialfeminista\Mapper\DbTable\TableAbstract::countByQuery()
     ...
     *
     * @param tribialfeminista\Model\Raw\ModelAbstract $model The model to delete
     * @return int
     */
    public abstract function delete(\tribialfeminista\Model\Raw\ModelAbstract $model);
    ...
    {
        $adapter = new \tribialfeminista\Model\Paginator($select, $this);
     ...
     * @return tribialfeminista\Model\Raw\ModelAbstract|null
     */
     ...
     * @return array All tribialfeminista\Model\Raw\ModelAbstract meeting the criteria
     */
     ...
     * @param tribialfeminista\Model\Raw\ModelAbstract|null $model
     * @return tribialfeminista\Model\Raw\ModelAbstract|null The matching models found or null if not found
     */
     ...
     *
     * @return tribialfeminista\Mapper\DbTable\TableAbstract
     */
     ...
     *
     * @param new tribialfeminista\Model\Raw\ModelAbstract $model
     * @return array
     */
     ...
     * @param tribialfeminista\Model\Raw\ModelAbstract|null $entry The object to load the data into, or null to have one created
     */
    protected abstract function loadModel($data, $entry);

    /**
     * Cleans urlIdentifier fields, so they can be used as url slugs
     * @param \tribialfeminista\Model\Raw\ModelAbstract $model The model to clean
     *
     */
    protected function _setCleanUrlIdentifiers(\tribialfeminista\Model\Raw\ModelAbstract $model)
    {
